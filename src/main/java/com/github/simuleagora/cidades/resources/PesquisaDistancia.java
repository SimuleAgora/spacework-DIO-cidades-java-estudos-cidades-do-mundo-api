...
import com.github.simuleagora.cidades.service.DistanceService;
import com.github.simuleagora.cidades.service.EarthRadius;
...
public class PesquisaDistancia {

  Logger log = LoggerFactory.getLogger(PesquisaDistancia.class);

  private final DistanceService service;

  public PesquisaDistancia(DistanceService service) {
